 ...
 * q: OTG FS,SDIO,RNG时钟分频因子，取值 4~15
 * 函数调用举例，使用HSE设置时钟：SYSCLK=HCLK=180M,PCLK2=HCLK/2=90M,PCLK1=HCLK/4=45M
...
void HSE_SetSysClock(uint32_t m, uint32_t n, uint32_t p, uint32_t q)	
{
  ...
  RCC_HSEConfig(RCC_HSE_ON);      // 使能HSE，开启外部晶振，野火F429使用 HSE=25M
